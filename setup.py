...
setup(name=APPNAME,
    ...
    scripts=['radiotray'],
    data_files = [
      ('share/applications', ['data/radiotray.png',]),
      ('share/doc/radiotray-%s' % APPVERSION,
          ['AUTHORS', 'ChangeLog', 'CONTRIBUTORS', 'COPYING', 'COPYRIGHT',
           'INSTALL', 'LICENSE', 'NEWS', 'MAINTAINERS', 'README', 'TODO']),
      ('share/radiotray/images', ['data/images/radio.png',]),
      ('share/pixmaps', ['data/images/radio.png',]),
    ],
